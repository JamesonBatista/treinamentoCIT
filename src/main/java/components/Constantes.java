...
import static regressivo.RegressionTest.AMBIENTE;
...
//    String BASE_URL_PS = "http://10.233.129.39:8443";
    ...
    static String selecionaAmbiente() {
        EnvironmentProperties env = EnvironmentProperties.getGlobal();
        String environment = env.asString("environment", AMBIENTE);
        ...
        } else if (StringUtils.equalsIgnoreCase(environment, "teste")) {
            url = "https://reqres.in/";
        } else {
